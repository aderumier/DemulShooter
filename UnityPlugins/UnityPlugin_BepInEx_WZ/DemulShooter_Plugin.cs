...
namespace BepInEx_DemulShooter_Plugin
{
    ...
    {
        public const String pluginGuid = "argonlefou.demulshooter.wisdomzombies";
        public const String pluginName = "WisdomZombies_BepInEx_DemulShooter_Plugin";
        public const String pluginVersion = "17.0.0.0";
        public const String pluginConfigFile = "WisdomZombies_BepInEx_DemulShooter_Plugin.ini";
        ...
        public static bool UseTicketsFeeder = false;
        ...
        public static int[] RemainingTicketsOut = new int[4];
        ...
        public void Awake()
        {
            ...
            if (File.Exists(Plugin_IniFile.FInfo.FullName))
            {
                try
                {
                    ...
                    Plugin_IniFile.IniReadBoolValue("SYSTEM", "USE_TICKETS_FEEDER", ref UseTicketsFeeder);
        ...
        public void Update()
        {
            ...
            {
                //Reading Ticket Feeder simulated info
                //if (UseTicketsFeeder)
                //{
                //    if (TicketSensors[i].GetButtonDown() && RemainingTicketsOut[i] > 0)
                //        RemainingTicketsOut[i]--;

                //    OutputData.TicketFeeder[i] = RemainingTicketsOut[i] > 0 ? (byte)1 : (byte)0;
                //}
                OutputData.IsPlaying[i] = MonoSingleton<GameData>.Instance.GetPlayerLive(i) ? (byte)1 : (byte)0;
            }
